...
{"urlButton": {"displayText": "▸ʏᴏᴜᴛᴜʙᴇ ɢᴇᴍᴘʏ◂","url": "https://www.youtube.com/channel/UCZoVmApPxtLYgUWwBD4nbCw"}},
{"urlButton": {"displayText": "✿𝗢𝗪𝗡𝗘𝗥✿","url": "https://wa.me/" + nomerowner}},
{"quickReplyButton": {"displayText": "ɢʀᴜᴘ-ʙᴏᴛ","id": `${prefix}donasi`}},
{"quickReplyButton": {"displayText": "ᴘʀᴏғɪʟᴇ-sᴀʏᴀ","id": `${prefix}saya`,}},
{"quickReplyButton": {"displayText": "ᴠᴇʀsɪ ʙᴏᴛ","id": `${prefix}versi`}}
]}}}, {})
...
const nyz4 = {text:dua,footer: 'Process...',buttons: nyz3,headerType: 1}
...
const nyz6 = {image: {url: tiga},caption: dua,footer: 'Process...',buttons: nyz5,headerType: 4}
nayla.sendMessage(from, nyz6)}

const reply = (teksnya) => {
const nyz1 = [{index: 1, urlButton: {displayText: 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ ɢᴇᴍᴘʏ', url: 'https://wa.me/' + nomerowner}}]
const nyz2 = {text: "\n" + teksnya, footer: 'Process...', templateButtons: nyz1}
...
{title: `SENDOK (${myHadiah(sender, "sendok")})`, rowId: "GempyTon", description: "HARGA : 13.000"},
{title: `SANDAL (${myHadiah(sender, "sandal")})`, rowId: "GempyTon", description: "HARGA : 20.000"},
{title: `MINYAK (${myHadiah(sender, "minyak")})`, rowId: "GempyTon", description: "HARGA : 30.000"},
{title: `IKAN (${myHadiah(sender, "ikan")})`, rowId: "GempyTon", description: "HARGA : 50.000"},
{title: `PANCI (${myHadiah(sender, "panci")})`, rowId: "GempyTon", description: "HARGA : 75.000"},
{title: `MOBIL (${myHadiah(sender, "mobil")})`, rowId: "GempyTon", description: "HARGA : 100.000"}]}]
...
┃➧ ᴇxᴘ > ${myExp(sender)}
┃➧ ᴜᴀɴɢ > ${myUang(sender)}
┃➧ ᴇɴᴇʀɢʏ > ${myEnergi(sender)}
┃➧ ᴋᴀʀᴀᴋᴛᴇʀ > ${myKarakter(sender)}
┃➧ ᴏғғɪᴄᴇʀ > ${myOfficer(sender)}
┃➧ ʜᴜsʙᴜ > ${myHusbu(sender)}
┃➧ ᴡᴀɪғᴜ > ${myWaifu(sender)}
┃➧ ʜᴏᴍᴇ > ${myHome(sender)}
┗━━━━━━━━━━⫸
...
await sendMenu(from, menuu, "ᴘᴇɴᴛᴀʙᴏᴛ - ᴄʀᴇᴀᴛᴇᴅ ʙʏ ɢᴇᴍᴘʏ", await nayla.sendnew(from, {image : {url:`./media/image/menu/${gg}.jpg` }, caption: menuu}),{quoted:nay1})
break
case 's':
case 'sticker':
case 'stiker':
